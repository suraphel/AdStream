...
const VAN_TYPES = ["Minivans", "Passenger Vans", "Cargo Vans", "Microbuses"];

const SCOOTER_TYPES = ["Gasoline Scooters", "Electric Scooters"];
...
const HOUSE_TYPES = [
  ...
  "Townhouses",
  "Standalone Houses",
  "G+1, G+2, etc. (multi-story)",
];

const HOME_AND_GARDEN_TOOLS_AND_MACHINES = [
  "Furniture",
  "Home Appliances",
  "Kitchen Appliances",
  "Lawn Mowers",
...
const SERVICE_CATEGORIES = [
  "Repair and Maintenance (Automotive, Home, etc.)",
  "Automotive Services",
  "Delivery Services",
  "Commercial Services",
...
export function FilterSidebar({
  ...
  const handleSelectAllBrands = () => {
    ...
    const currentBrands = filters.brands || [];
    const allSelected = allBrands.every((brand) =>
                ...
                <CollapsibleContent className="space-y-4 pt-3">
                          ...
                          {getBrandsList().map((brand) => (
                            ...
                            >
                              <Checkbox
                                id={brand}
                                checked={
                                  filters.brands?.includes(brand) || false
                                }
                  ...
                  <div>
                    ...
                    <Slider
                      value={localMileage}
                      onValueChange={(value) =>
                        setLocalMileage(value as [number, number])
                      }
                      max={500000}
                      step={5000}
